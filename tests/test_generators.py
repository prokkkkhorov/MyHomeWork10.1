...
@pytest.mark.parametrize('description, expected_description', [
    ("Перевод организации", [{
        "id": 939719570,
        "state": "EXECUTED",
        "date": "2018-06-30T02:08:58.425572",
...
def test_transaction_descriptions(transactions, description, expected_description):
    """
    Функция для тестирования приёма списка словарей с транзакциями
    и возвращения описания каждой операции по очереди.
    """
